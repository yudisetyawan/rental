    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent inte = new Intent(MainActivity.this, com.aplikasi.mobil.BuatKontak.class);
                startActivity(inte);
            }
        });
        ma = this;
        dbcenter = new com.aplikasi.mobil.DataHelper(this);
        RefreshList();
    }
                ...
                builder.setItems(dialogitem, new
                        DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int item) {
                                switch (item) {
                                    case 0:
                                        Intent i = new Intent(getApplicationContext(), com.aplikasi.mobil.LihatKontak.class);
                                        i.putExtra("nama", selection);
                                        startActivity(i);
                                        break;
                                    case 1:
                                        Intent in = new Intent(getApplicationContext(), com.aplikasi.mobil.UpdateKontak.class);
